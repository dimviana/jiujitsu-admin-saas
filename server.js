...
app.get('/api/initial-data', async (req, res, next) => {
    try {
        ...
        try { await pool.query("SELECT heroJson FROM theme_settings LIMIT 1"); } catch (e) { await pool.query("ALTER TABLE theme_settings ADD COLUMN heroJson LONGTEXT"); }
...
app.post('/api/settings', async (req, res, next) => {
    ...
    try {
        if (academyId) {
            ...
            // Include heroJson in the update
